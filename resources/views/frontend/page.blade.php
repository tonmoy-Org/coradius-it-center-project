...
@section('content')
    <section class="course-details-area p-b-50">
        ...
        <div class="course-details-header-wrapper p-t-60 p-b-95 p-t-md-40 p-b-md-50" style="background: linear-gradient(180deg, var(--color-hero-bg-start, #001F5C) 0%, var(--color-hero-bg-end, #0B1226) 100%) !important;">
