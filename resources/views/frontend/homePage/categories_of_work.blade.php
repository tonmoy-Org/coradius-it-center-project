                            ...
                            <div class="cow-card cow-card-only-image h-100">
                                @if($hasLink)
                                    <a href="{{ $card['link'] }}" {{ str_starts_with($card['link'], '#') ? '' : 'target="_blank"' }}>
                                        <img src="{{ asset($imagePath) }}" alt="Category Image" loading="lazy" decoding="async">
                                    </a>
                                @else
                                    <img src="{{ asset($imagePath) }}" alt="Category Image" loading="lazy" decoding="async">
                                @endif
                                    ...
                                    @if($hasImage)
                                        @if($hasLink)
                                            <a href="{{ $card['link'] }}" {{ str_starts_with($card['link'], '#') ? '' : 'target="_blank"' }} class="cow-card-img-floating-wrapper">
                                                <img src="{{ asset($imagePath) }}" class="cow-card-img-floating" alt="{{ $card['title'] ?? 'Category Image' }}" loading="lazy" decoding="async">
                                            </a>
                                        @else
