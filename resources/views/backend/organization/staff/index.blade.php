    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="header-top d-flex justify-content-between align-items-center">
                <h3 class="section-title">{{__('staff_list') }}</h3>
                <div class="oftions-content-right mb-12">
                    <a href="{{ route('organization.staff.create',['organization_id' => $organization_id]) }}" class="d-flex align-items-center btn sg-btn-primary gap-2">
            ...
            <div class="default-tab-list table-responsive default-tab-list-v2 activeItem-bd-md bg-white redious-border p-20 p-sm-30">
                @if(request()->routeIs('organization.staff.organization'))
                    @include('backend.staff.organization.topber')
                @endif
