            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('organization.profile.password-change') }}" class="d-flex align-items-center btn sg-btn-primary gap-2">
                    ...
                    <div class="bg-white redious-border">
                        ...
                        <form method="POST" action="{{ route('organization.profile.update') }}" enctype="multipart/form-data" class="form">
                            @csrf
                            @method('patch')
