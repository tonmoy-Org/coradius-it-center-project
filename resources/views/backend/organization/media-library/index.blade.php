                ...
                <div class="col-lg-12">
                    ...
                    <div class="bg-white redious-border p-20 p-sm-30">
                        ...
                        <div class="row gx-20 gy-20 media_list">
                            @include('backend.organization.media-library.media_list')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="addMedia" tabindex="-1" aria-labelledby="addMediaLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('organization.media-library.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row gx-20">
                        <div class="col-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.media-uploader').dropzone({
                url: '{{ route('organization.media-library.store') }}',
            ...
            $(document).on('change', '#bulkAction', function() {
                ...
                if (length > 0) {
                    if (val == 'delete_file') {
                        ...
                        delete_row('{{ route('organization.media.destroy') }}', ids, true);
                    } else if (val == 'copy') {
                        let all_text = [];
                        $.each(checked_checkboxes, function(index, element) {
        ...
        function fetch_data() {
            ...
            $.ajax({
                url: '{{ route('organization.media-library.index') }}',
                type: 'GET',
                data: {
                    page: 1,
