<form action="{{ route('assignments.update',$assignment->id) }}" method="post" class="form"
    ...
    <div class="row gx-20">
        ...
        <div class="col-6">
            <div class="mb-4">
                <div class="mb-20">
                    ...
                    <input id="datePicker" type="text" name="deadline" value="{{ \Carbon\Carbon::parse($assignment->deadline)->format('Y-m-d H:i:s') }}"
        ...
        @include('backend.common.media-input',[
                        ...
                        'edit'  => $assignment,
                        'image_object'  => $assignment->media->image_variants ?? '',
