            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="section-title mb-0" style="font-weight: 500;">{{ __('Newsletter Section Settings') }}</h3>
                                    ...
                                    <div class="row gx-20 gy-3">
                                        <div class="col-12 col-lg-12">
                                            <div class="d-flex align-items-center justify-content-between gap-2 sandbox_mode_div mb-4">
                                                ...
                                                <label class="form-label m-0" for="show_newsletter" style="font-size: 13px; font-weight: 400;">Enable Section</label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control rounded-2 py-2" id="title" name="newsletter_title"
                                                   placeholder="" value="{{ setting('newsletter_title', $lang) }}">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control rounded-2 py-2" id="newsletter_description" name="newsletter_description" rows="2"
                                                      placeholder="">{{ setting('newsletter_description',$lang) ?: '' }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control rounded-2 py-2" id="promo_banner_countdown_title" name="promo_banner_countdown_title"
                                                   placeholder="" value="{{ setting('promo_banner_countdown_title', $lang) }}">
