...
@section('title', __('resource_link_settings'))
@section('content')
                        ...
                        <form action="{{ route('footer.update-menu') }}" method="POST" class="form">@csrf
                            ...
                            <div class="row gx-20">
                                <div class="d-flex gap-12 sandbox_mode_div mb-4">
                                    <input type="hidden" name="show_resource_link" value="{{ setting('show_resource_link') == 1 ? 1 : 0 }}">
                                    <label class="form-label"
                                           for="show_resource_link">{{ __('show_resource_link') }}</label>
                                    <div class="setting-check">
                                        <input type="checkbox" value="1" id="show_resource_link"
                                               class="sandbox_mode" {{ setting('show_resource_link') == 1 ? 'checked' : '' }}>
                                        <label for="show_resource_link"></label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-4">
                                        <label for="title" class="form-label">{{__('menu_title') }}</label>
                                        <input type="text" class="form-control rounded-2" id="title" name="resource_link_title"
                                               placeholder="{{ __('enter_title') }}" value="{{ setting('resource_link_title',app()->getLocale()) }}">
