                                    ...
                                    <div class="row gx-20 gy-3">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control rounded-2 py-2" id="contact_page_banner_title" name="contact_page_banner_title"
                                                   value="{{ setting('contact_page_banner_title', $lang) ?: (setting('contact_page_banner_title') ?: 'We\'d Love to Hear From You') }}">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control rounded-2 py-2" id="contact_page_banner_description" name="contact_page_banner_description" rows="2">{{ setting('contact_page_banner_description', $lang) ?: (setting('contact_page_banner_description') ?: 'Have questions, feedback, or need support? Reach out to our team and we will get back to you promptly.') }}</textarea>
                                        </div>
